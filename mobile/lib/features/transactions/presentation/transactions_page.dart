...
const _categoryIcons = <String, IconData>{
  ...
  'aksesuar': Icons.checkroom_outlined,
  'ayakkabı': Icons.shopping_bag_outlined,
  'çanta': Icons.shopping_bag_outlined,
  'alışveriş': Icons.shopping_cart_outlined,
  'market': Icons.local_grocery_store_outlined,
  'süpermarket': Icons.local_grocery_store_outlined,
  // ── Yiyecek & İçecek ───────────────────────────────────────
  ...
  'sigara': Icons.local_bar_outlined,
  // ── Ev & Yaşam ─────────────────────────────────────────────
  'ev & yaşam': Icons.home_outlined,
  'yaşam': Icons.home_outlined,
  'kira': Icons.house_outlined,
  'mobilya': Icons.chair_outlined,
  'dekorasyon': Icons.chair_outlined,
  'beyaz eşya': Icons.kitchen_outlined,
  ...
  'telefon': Icons.phone_android_outlined,
  'dijital abonelik': Icons.subscriptions_outlined,
  ...
  'toplu taşıma': Icons.directions_bus_outlined,
  'taksi': Icons.local_taxi_outlined,
  'araç bakım': Icons.car_repair_outlined,
  'otopark': Icons.local_parking_outlined,
  'park ': Icons.local_parking_outlined,
  'uçak': Icons.flight_outlined,
  'seyahat': Icons.travel_explore_outlined,
  // ── Sağlık ─────────────────────────────────────────────────
  'sağlık': Icons.health_and_safety_outlined,
  'doktor': Icons.local_hospital_outlined,
  'hastane': Icons.local_hospital_outlined,
  'eczane': Icons.local_pharmacy_outlined,
  'spor': Icons.fitness_center_outlined,
  'diş': Icons.medical_services_outlined,
  'optik': Icons.visibility_outlined,
  // ── Eğitim & Kişisel Gelişim ───────────────────────────────
  'eğitim': Icons.school_outlined,
  'kitap': Icons.menu_book_outlined,
  'dergi': Icons.menu_book_outlined,
  'kurs': Icons.workspace_premium_outlined,
  'sertifika': Icons.workspace_premium_outlined,
  // ── Eğlence & Hobi ─────────────────────────────────────────
  'eğlence': Icons.movie_outlined,
  'sinema': Icons.theaters_outlined,
  'tiyatro': Icons.theaters_outlined,
  'hobi': Icons.sports_esports_outlined,
  'oyun': Icons.sports_esports_outlined,
  'müzik': Icons.music_note_outlined,
  'otel': Icons.hotel_outlined,
  // ── Finans & Bankacılık ────────────────────────────────────
  'banka': Icons.account_balance_outlined,
  'finans': Icons.account_balance_outlined,
  'banka ücreti': Icons.account_balance_wallet_outlined,
  'faiz': Icons.percent_outlined,
  'komisyon': Icons.percent_outlined,
  'sigorta': Icons.security_outlined,
  'kredi': Icons.credit_score_outlined,
  'yatırım': Icons.trending_up_outlined,
  'vergi': Icons.gavel_outlined,
  'borç': Icons.payment_outlined,
  // ── Teknoloji ──────────────────────────────────────────────
  'teknoloji': Icons.computer_outlined,
  'elektronik': Icons.devices_outlined,
  'yazılım': Icons.app_shortcut_outlined,
  'uygulama': Icons.app_shortcut_outlined,
  // ── Kişisel Bakım ──────────────────────────────────────────
  'kişisel bakım': Icons.face_retouching_natural_outlined,
  'kuaför': Icons.content_cut_outlined,
  'güzellik': Icons.content_cut_outlined,
  'kozmetik': Icons.brush_outlined,
  // ── Çocuk & Aile ───────────────────────────────────────────
  'çocuk': Icons.child_care_outlined,
  'bebek': Icons.child_care_outlined,
  'oyuncak': Icons.toys_outlined,
  // ── Bağış & Diğer ─────────────────────────────────────────
  'bağış': Icons.volunteer_activism_outlined,
  'yardım': Icons.volunteer_activism_outlined,
