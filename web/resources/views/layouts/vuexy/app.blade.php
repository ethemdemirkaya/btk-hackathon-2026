...
<html
  ...
  <head>
    ...
    <title>@yield('title', config('app.name')) | Paranette</title>
            ...
            <div class="navbar-nav-right d-flex align-items-center justify-content-between w-100" id="navbar-collapse">
              ...
              <ul class="navbar-nav flex-row align-items-center ms-md-auto">
                ...
                <li class="nav-item dropdown-notifications navbar-dropdown dropdown me-3 me-xl-1">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end p-0" style="min-width:20rem;max-height:380px;overflow-y:auto">
                    <li class="dropdown-header border-bottom d-flex align-items-center py-3 ps-4 pe-3 mb-1">
                      <h5 class="mb-0 me-auto">Bildirimler</h5>
                    </li>
                    <li class="text-center py-3 text-muted small">Yeni bildirim yok</li>
                  </ul>
                </li>
            ...
            <footer class="content-footer footer bg-footer-theme">
              <div class="container-xxl">
                <div class="footer-container d-flex align-items-center justify-content-between py-4 flex-md-row flex-column">
                  <div class="text-body">
                    &copy; {{ date('Y') }}, <strong>Paranette</strong> &mdash; BTK Akademi Hackathon 2026
                  </div>
                </div>
              </div>
            </footer>
